...
import { platformNames } from '@/data/toolsData';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        throw new Error(result.message || '添加工具失败');
      }
    } catch (error: any) {
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="md:col-span-2">
                ...
                <p className="text-xs text-gray-500 mb-2">请至少选择一个适用平台或工具分类</p>
                ...
                {formData.platforms.length === 0 && formData.categories.length === 0 && (
                  <p className="mt-1 text-xs text-red-500">请至少选择一个适用平台或工具分类</p>
                )}
              </div>
              ...
              {/* 截图上传 */}
              <div className="md:col-span-2 mt-4">
                <h3 className="text-lg font-medium text-gray-900 mb-3">截图上传</h3>
                <div className="h-px bg-gray-200 mb-4"></div>
              </div>
